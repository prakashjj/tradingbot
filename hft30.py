        ...
        try:
            ...
            if '1m' in signals:
                ...
                if 'ht_sine_percent_to_min' in signals['1m'] and 'ht_sine_percent_to_max' in signals['1m']:
                    ...
                    min_threshold = signals['1m']['min_threshold']
                    max_threshold = signals['1m']['max_threshold']

                    print("min_threshold, mtf_average, max_threshold is:", min_threshold, mtf_average, max_threshold)

                    # Check if the signals are strong enough to open a trade
                    if percent_to_min_val < percent_to_max_val and close_price < mtf_average:
                        print("BUY signal detected.")
                    
                    elif percent_to_max_val < percent_to_min_val and close_price > mtf_average:
